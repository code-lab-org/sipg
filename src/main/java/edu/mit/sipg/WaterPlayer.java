...
/**
 * The application for a player that controls water sector infrastructure.
 * 
 * @author Paul T. Grogan
 */
public class WaterPlayer {
	private static Logger logger = Logger.getLogger(WaterPlayer.class);
	...
	public static void main(String[] args) {
		...
		Scenario scenario = new GameScenario(
				Arrays.asList(GameScenario.INDUSTRIAL, 
						GameScenario.URBAN, 
						GameScenario.RURAL),
				Arrays.asList(Sector.WATER), false);
