...
public class LocalWaterElement extends DefaultElement implements WaterElement {	
	...
	public static class WaterState extends DefaultState implements ResourceExchanging {
		...
		public void setProduced(LocalElement element, Resource produced, long duration) {
			this.produced = produced;
			// re-iterate tick to resolve controller order dependencies
			iterateTick(element, duration);
		}
		public void setReceived(LocalElement element, Resource received, long duration) {
