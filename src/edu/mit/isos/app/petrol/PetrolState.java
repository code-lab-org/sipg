...
public class PetrolState extends DefaultState implements ResourceExchanging {
	...
	protected double getPetrolSentToSocial() {
	...
	protected double getPetrolSentToElect() {
