...
public enum ElementTemplate {
	SMALL_LIVESTOCK(Sector.AGRICULTURE, "Small Livestock Field", 1900),
	LARGE_LIVESTOCK(Sector.AGRICULTURE, "Large Livestock Field", 1900),
	SMALL_DATES(Sector.AGRICULTURE, "Small Dates Field", 1900),
	LARGE_DATES(Sector.AGRICULTURE, "Large Dates Field", 1900),
	SMALL_GRAINS(Sector.AGRICULTURE, "Small Grains Field", 1970),
	LARGE_GRAINS(Sector.AGRICULTURE, "Large Grains Field", 1970);
	 ...
	 * @param name the name
	 */
	private ElementTemplate(Sector sector, String name, long yearAvailable) {
		this.sector = sector;
		this.name = name;
