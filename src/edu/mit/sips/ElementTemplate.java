...
public enum ElementTemplate {
	LIVESTOCK_1		(Sector.AGRICULTURE,	false, 	"Small Livestock Field", 			1900),
	LIVESTOCK_2		(Sector.AGRICULTURE,	false, 	"Large Livestock Field", 			1900),
	DATES_1			(Sector.AGRICULTURE,	false, 	"Small Date Field", 				1900),
	DATES_2			(Sector.AGRICULTURE,	false, 	"Large Date Field",					1900),
	GRAINS_1		(Sector.AGRICULTURE,	false, 	"Small Grain Field", 				1970),
	GRAINS_2		(Sector.AGRICULTURE,	false, 	"Large Grain Field", 				1970),
	FOOD_TRANSPORT_1(Sector.AGRICULTURE,	true, 	"Default Food Transport", 			1900),
	AQUIFER_PUMP_1	(Sector.WATER, 			false, 	"Small Aquifer Pump", 				1900),
	AQUIFER_PUMP_2	(Sector.WATER, 			false, 	"Medium Aquifer Pump", 				1900),
	AQUIFER_PUMP_3	(Sector.WATER, 			false, 	"Large Aquifer Pump", 				1900),
	TD_DESAL_1		(Sector.WATER, 			false, 	"Thermal Distillation Desal. Plant",1960),
	TD_DESAL_2		(Sector.WATER, 			false, 	"Improved TD Desal. Plant", 		1980),
	TD_DESAL_3		(Sector.WATER, 			false, 	"Advanced TD Desal. Plant", 		2000),
	RO_DESAL_1		(Sector.WATER, 			false, 	"Reverse Osmosis Desal. Plant",		1970),
	RO_DESAL_2		(Sector.WATER, 			false, 	"Improved RO Desal. Plant", 		1990),
	RO_DESAL_3		(Sector.WATER, 			false, 	"Advanced RO Desal. Plant", 		2010),
	WATER_PIPELINE_1(Sector.WATER, 			true, 	"Small Water Pipeline", 			1950),
	WATER_PIPELINE_2(Sector.WATER, 			true, 	"Medium Water Pipeline", 			1950),
	WATER_PIPELINE_3(Sector.WATER, 			true, 	"Large Water Pipeline", 			1950);
	...
	public InfrastructureElement createElement(long year, 
		...
		case AQUIFER_PUMP_1:
			return DefaultWaterElement.createProductionElement(
					this, name + " " + ++instanceId, location, location, 
					new SimpleLifecycleModel(timeAvailable, year, 1, 50, 1, 
							30e6, 3e6, 6e6, true), 
					1, 1e6, 0, 0.0053, 3);
		case AQUIFER_PUMP_2:
			return DefaultWaterElement.createProductionElement(
		...
		case AQUIFER_PUMP_3:
			return DefaultWaterElement.createProductionElement(
					this, name + " " + ++instanceId, location, location, 
					new SimpleLifecycleModel(timeAvailable, year, 2, 50, 1, 
							125e6, 12.5e6, 25e6, true), 
					1, 25e6, 0, 0.0053, 2.5);
		case TD_DESAL_1:
			return DefaultWaterElement.createProductionElement(
					this, name + " " + ++instanceId, location, location, 
					new SimpleLifecycleModel(timeAvailable, year, 5, 40, 2, 
