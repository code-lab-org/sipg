 ...
 */
public class DefaultElectricitySoS extends DefaultInfrastructureSoS.Local implements ElectricitySoS {
	...
	public List<ElectricitySystem> getNestedSystems() {
		...
		for(Society society : getSociety().getNestedSocieties()) {
			if(society.getEnergySystem() instanceof EnergySystem.Local){ 
				systems.add(((EnergySystem.Local) society.getEnergySystem()).getElectricitySystem());
			}
		}
