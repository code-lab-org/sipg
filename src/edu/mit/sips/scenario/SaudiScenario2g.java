 ...
 */
public final class SaudiScenario2g extends DefaultScenario {
		...
		return new City(INDUSTRIAL, 
				sectors.contains(Sector.AGRICULTURE)?
						new LocalAgricultureSystem(8e3, 0.04,
								Arrays.asList(
										(AgricultureElement) SaudiElementTemplate2.WHEAT_1.createElement(1940, INDUSTRIAL, INDUSTRIAL)
		...
		return new City(RURAL, 
				sectors.contains(Sector.AGRICULTURE)?
						new LocalAgricultureSystem(15e3, 0.40,
								Arrays.asList(
										(AgricultureElement) SaudiElementTemplate2.WHEAT_1.createElement(1940, RURAL, RURAL)
										,(AgricultureElement) SaudiElementTemplate2.FOOD_TRANSPORT_1.createElement(1940, RURAL, INDUSTRIAL)
										,(AgricultureElement) SaudiElementTemplate2.FOOD_TRANSPORT_1.createElement(1940, RURAL, URBAN)
		...
		return new City(URBAN, 
				sectors.contains(Sector.AGRICULTURE)?
						new LocalAgricultureSystem(10e3, 0.04,
								Arrays.asList(
										(AgricultureElement) SaudiElementTemplate2.WHEAT_1.createElement(1940, URBAN, URBAN)
